...
class ControllerArgs:
    ...
    def _create_parser():
        parser = argparse.ArgumentParser(
            ...
            description='''Use this program to know quantity of calories you spend per day''',
            epilog='''(c) Chersilmuk inc.'''
        )
        group = parser.add_argument_group(title='Parameters')
        group.add_argument('--gender', '-g', required=True, choices=[1, 2], type=int, metavar='|1 - MALE, 2 - FEMALE|')
        group.add_argument('--activity', '-pa', required=True, choices=[1, 2, 3, 4, 5], type=int,
