...
class ControllerArgs:
    ...
    def _create_parser():
        ...
        group.add_argument('--gender', '-g', required=True, choices=[1, 2],
        type=int, metavar='|1 - MALE, 2 - FEMALE|')
        group.add_argument('--activity', '-pa', required=True,
        ...
        group.add_argument('--weight', '-w',
                            required=True, choices=range(35, 239, 1),
                           type=int, metavar='|WEIGHT >34 and <240|')
        group.add_argument('--height', '-ht', required=True,
                            choices=range(120, 249, 1), type=int,
                            metavar='|HEIGHT >119 and <250|')
        group.add_argument('--age', '-a', required=True,
                            choices=range(13, 79, 1), type=int,
