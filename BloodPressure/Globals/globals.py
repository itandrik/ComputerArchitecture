...
delete_sql = {"pressure_data": "id_pressure_data",
              "person": "id_person",
              "doctor": "id_doctor"}
update_sql = {"pressure_data": ["date=", "time=", "upper_level=",
                                "lower_level=", "pulse=",
                                "person_id_person=",
                                "doctor_id_doctor="],
...
# Controller data
table_data = {"pressure_data": ("date", "time", "upper level",
                                "lower level", "pulse", "person_id_person",
                                "doctor_id_doctor"),
              "person": ("first name", "last name", "middle name", "age",
                         "weight", "height", "phone_number"),
              "doctor": ("first name", "last name", "middle name",
