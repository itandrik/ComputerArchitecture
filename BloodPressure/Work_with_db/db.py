...
create_connector = {"mysql": mysql.connector.connect(user='root',
                                                     password='4y4yndpiK',
                                                     host='127.0.0.1',
                                                     database='BloodPressure'),
                    "sqlite": sqlite3.connect(
                        '/home/dron/ComputerArchitecture/'
                        'BloodPressure/Databases/blood_pressure_sqlite'),
                    "postgreSQL": psycopg2.connect(
                        host='127.0.0.1',
                        user='postgres', password='4y4yndpiK',
                        dbname='mydb')}
